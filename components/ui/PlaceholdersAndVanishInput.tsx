...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "relative mx-auto h-12 w-[500px] max-w-xl scale-110 overflow-hidden rounded-full bg-zinc-800 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),_0px_1px_0px_0px_rgba(25,28,33,0.02),_0px_0px_0px_1px_rgba(25,28,33,0.08)] transition duration-200 smd:scale-100 sm:w-full sm:scale-90",
        value && "bg-zinc-800",
      )}
