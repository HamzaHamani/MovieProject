    ...
    >
      <CarouselContent>
        {popularCast.map((cast, index) => (
          <CarouselItem
            key={index}
            className="Ctex6:basis-1/4 flex basis-1/6 items-center justify-center xds:basis-1/5 h1text8:basis-1/3 ss:basis-1/2 s:basis-52"
          >
            <div className="bg-re-500 p1 flex w-[300px] gap-2">
