    ...
    <>
      {isDesktop ? (
        ...
        <Drawer open={open} onOpenChange={setOpen}>
          ...
          <DrawerContent className="max-h-[88svh] min-h-[40svh] overflow-hidden border border-white/20 bg-[#0a0a0ed1] shadow-[0_24px_80px_-28px_rgba(0,0,0,0.95)] backdrop-blur-xl">
